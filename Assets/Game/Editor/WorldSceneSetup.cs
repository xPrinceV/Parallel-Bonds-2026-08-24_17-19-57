...
public static class WorldSceneSetup
{
    ...
    private static void SetUpWorlds()
    {
        ...
        try
        {
            ...
            timerData.FindProperty("timer").floatValue = StateSwitchController.ResidenceDuration;
            ...
            Debug.Log("World setup complete. Review and save Main.unity. Both maps initially share the same layout; customize EchoWorld/Content separately. Automatic switching runs every 90 seconds.", system);
        }
